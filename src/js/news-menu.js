...
// Импортируем изображения для правильной обработки Vite
import news1Image from '../img/news/cards/news1.webp';
import news2Image from '../img/news/cards/news2.webp';
import news3Image from '../img/news/cards/news3.webp';
import news4Image from '../img/news/cards/news4.webp';

// Маппинг путей к импортированным изображениям
const imageMap = {
  '/img/news/cards/news1.webp': news1Image,
  '/img/news/cards/news2.webp': news2Image,
  '/img/news/cards/news3.webp': news3Image,
  '/img/news/cards/news4.webp': news4Image,
};
...
class NewsMenu {
  ...
  createNewsCard(news) {
    ...
    const imagePath = getImagePath(news.image);
      ...
      <a href="${news.link || '#'}" class="wrapper-card-new">
        ...
        <div class="card-news">
          <div class="card-news__image">
            <img src="${imagePath}" alt="${news.imageAlt || news.title}" />
          </div>
